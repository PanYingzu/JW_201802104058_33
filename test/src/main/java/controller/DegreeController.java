...
public class DegreeController extends HttpServlet {
    ...
    //请使用以下JSON测试修改功能
    //{"description":"博士后","id":1,"no":"01","remarks":""}

    /**
     * POST, http://49.235.2.175:8080/bysj/degree.ctl, 增加学位
    ...
    /**
     * DELETE, http://49.235.2.175:8080/bysj/degree.ctl?id=1, 删除id=1的学位
    ...
    /**
     * PUT, http://49.235.2.175:8080/bysj/degree.ctl, 修改学位
     *
    ...
    /**
     * GET, http://49.235.2.175:8080/bysj/degree.ctl?id=1, 查询id=1的学位
     * GET, http://49.235.2.175:8080/bysj/degree.ctl, 查询所有的学位
     * 把一个或所有学位对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
