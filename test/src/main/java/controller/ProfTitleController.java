...
public class ProfTitleController extends HttpServlet {
    ...
    //请使用以下JSON测试修改功能
    //{"description":"副教授","id":1,"no":"01","remarks":""}

    /**
     * POST, http://49.235.2.175:8080/bysj/profTitle.ctl, 增加头衔
    ...
    /**
     * DELETE, http://49.235.2.175:8080/bysj/profTitle.ctl?id=1, 删除id=1的头衔
    ...
    /**
     * PUT, http://49.235.2.175:8080/bysj/profTitle.ctl, 修改头衔
     *
    ...
    /**
     * GET, http://49.235.2.175:8080/bysj/profTitle.ctl?id=1, 查询id=1的头衔
     * GET, http://49.235.2.175:8080/bysj/profTitle.ctl, 查询所有的头衔
     * 把一个或所有头衔对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
