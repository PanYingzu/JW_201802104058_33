 ...
 */
//49.235.2.175:8080/JW25/myschool/index.html
@WebServlet("/school.ctl")
public class SchoolController extends HttpServlet {
    //请使用以下JSON测试增加功能
    //{"description":"土木学院","no":"02","remarks":""}
    //请使用以下JSON测试修改功能
    //{"description":"建筑城规学院","id":1,"no":"01","remarks":""}

    /**
     * POST, http://49.235.2.175:8080/bysj/school.ctl, 增加学院
    ...
    /**
     * DELETE, http://49.235.2.175:8080/bysj/school.ctl?id=1, 删除id=1的学院
    ...
    /**
     * PUT, http://49.235.2.175:8080/bysj/school.ctl, 修改学院
     *
    ...
    /**
     * GET, http://49.235.2.175:8080/bysj/school.ctl?id=1, 查询id=1的学院
     * GET, http://49.235.2.175:8080/bysj/school.ctl, 查询所有的学院
     * 把一个或所有学院对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
