...
public class DepartmentController extends HttpServlet {
            ...
            if (id_str != null) {
                ...
                if (paraType != null){
                    if(paraType.equals("school")){
                        responseDepartmentsForSchoolId(id,response);
                    }
                }else {
                    responseDepartment(id, response);
                }
            } else {
                responseDepartmentsForAll(response);
            }
        }catch (SQLException e){
            message.put("message", "数据库操作异常");
            e.printStackTrace();
    ...
    //响应所有专业对象
    private void responseDepartmentsForAll(HttpServletResponse response)
            throws ServletException, IOException, SQLException {
        //获得所有专业
    ...
    private void responseDepartmentsForSchoolId(int id, HttpServletResponse response)
            throws ServletException, IOException, SQLException {
        //根据学院的id查找专业
